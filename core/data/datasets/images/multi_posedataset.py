...
class MultiPoseDatasetDev(Dataset):
    def __init__(self,
        ...
        assert dataset_name in ['coco', 'aic', 'posetrack', 'halpe', 'JRDB2022', 'h36m', 'mhp', 'penn_action', '3DPW', '3DHP'], "invalid dataset name input"
    ...
    def _load_coco_keypoint_annotation_kernel(self, img_id):
        ...
        for obj in objs:
            ...
            if self.dataset_name == 'posetrack':
                ...
                keypoints = keypoints[:20,:]  # halpe has only 20 valid kp
